...
const GoDChooseVehicle = ({route}) => {
  ...
  const [selectedVehicle, setSelectedVehicle] = useState(route?.params?.isOnDemand?onDemandOrder?.vehicle:null);
  ...
  return (
      <View style={styles.screen}>
        <BackHeader title={t("common.gorexOnDemand")}
                    ...
                    RightPress={() => navigation.navigate("VehicleInformation", { isComingFromOnDemand : true })}
        ...
        {/*)}*/}
        {/*</ScrollView>*/}
        <Footer title={t("common.next")} disabled={!selectedVehicle} onPress={onPressNext} />
