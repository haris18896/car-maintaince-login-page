...
import {MenuBlack, NoTopUpCard, Visa, Mada, Master, American, Delete} from "../../assets";
        ...
        <View style={styles.rowItem}>
          <View style={[styles.card, styles.cardShadow]}>
            <View style={styles.imageContainer}>
              ...
              <TouchableOpacity onPress={() => {onPressDeleteCardIcon(item)}} style={{width:wp(50), alignItems:'flex-end'}}>
