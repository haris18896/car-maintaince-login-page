...
const OrderDetails = ({ route }) => {
    ...
    return (
        <View style={styles.container}>
            <BackHeader title={branch?branch.name:'Order Detail'} rightTitle={"Support"} rightIcon={Cart} RightPress={() => {navigation.navigate("GorexSupport");}}/>
            <ScrollView contentContainerStyle={styles.contentContainer} style={styles.paddedContent}>
                ...
                <View style={styles.row}>
                    ...
                    <Text style={[styles.incomplete, {color: order?.status === "cancel" ? Colors.RED : order?.status === "draft" ? Colors.OLIVE : Colors.DARKERGREEN,},]}>
                        {(order?.status === "draft" || order?.status === "order_placed" || order?.status === "order_accepted") ? "Incomplete" : order?.status}
                    </Text>
                </View>
                <View style={styles.row}>
                ...
                <CancelOrderModel
                    ...
                    modalCart={modalCart}
                />
                {(order?.on_demand && order?.status === "draft") || (!order?.on_demand && ( order?.status === "draft" || order?.status === "order_placed" || order?.status === "order_accepted")) ? (
            ...
            >
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        ...
                        navigation.navigate("GorexSupport");
                    }}
                >
