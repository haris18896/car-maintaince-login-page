...
const Tiers = () => {
    ...
    const getTierCardForItem = (item) =>{
        ...
        return (
            <ImageBackground source={Flatcard} style={{height: Utilities.hp(10), flexDirection: "row",marginBottom: Utilities.hp(2)}}>
                <Image style={{height:'100%', width:'17%'}} resizeMode={'center'} source={imageName} />
    ...
    return (
        <View style={{paddingVertical: Utilities.hp(2), backgroundColor: "white", paddingHorizontal: Utilities.wp(2), flex: 1,}}>
            ...
            {/*<ScrollView>*/}
            {/*    {getTierCard(Silver,t("gorexclub.silver"), t("gorexclub.silvermoney"), '1X')}*/}

            {/*    {getTierCard(Gold,t("gorexclub.gold"), t("gorexclub.goldmoney"), '2X')}*/}

            {/*    {getTierCard(Platinum,t("gorexclub.platinum"), t("gorexclub.platinummoney"), '3X')}*/}

            {/*    {getTierCard(Diamond,t("gorexclub.diamond"), t("gorexclub.diamondmoney"), '4X')}*/}
...
const Rewards = () => {
    ...
    const getRewardCard =  (title, isSpendBase, subTitle, isCompleted, rightImage, isReferFriend) =>{
        const { t, i18n } = useTranslation();
        const isRTL = i18n.language === "ar";
        return (
                ...
                <View style={{ height:'100%', width:'70%'}}>
                    ...
                    <View style={{flexDirection:'row',  paddingVertical:Utilities.hp(0.5)}}>
                        ...
                        <View style={{width:'44%', alignItems:'center'}}>
                            <TouchableOpacity style={styles.spendBased}>
                    ...
                    <View style={{height:'40%',justifyContent:'center'}}>
                        ...
                        <TouchableOpacity style={[styles.cardButton, {backgroundColor: isCompleted ? Colors.LIGHT_GREY : Colors?.ORANGE}]}
                                          ...
                                          onPress={() => {console.log(`Need to fix from Backend`);}}>
                            <View style={styles.row1}>
                                <Text style={[styles.buttonText, {left: Utilities.wp(13), color: isCompleted ? Colors.BLACK : Colors.WHITE,},]}>
                                    {isReferFriend?t("gorexclub.refernow"): (isCompleted? t("gorexclub.completed") : t("gorexclub.complete"))}
                                </Text>
    ...
    return (
        <View style={{flex:1, backgroundColor: "white",}}>
            <ScrollView contentContainerStyle={{alignItems:'center', paddingVertical: Utilities.hp(2)}}>
                ...
                {getRewardCard(t("gorexclub.signupreward"),false,t("gorexclub.x100"),userProfile?.profile_completed,GorexSignup, false)}

                {getRewardCard(t("gorexclub.completeprofile"),false,t("gorexclub.x100"),userProfile?.profile_completed,GorexSignup, false)}

                {getRewardCard(t("gorexclub.orderreward"),true,t("gorexclub.spendmore"),userProfile?.profile_completed,GorexOrderSticker, false)}

                {getRewardCard(t("gorexclub.friend"),false,t("gorexclub.x100"),userProfile?.profile_completed,GorexOrderSticker, true)}
